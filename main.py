...
def init_neo4j_vector(embeddings_model, docs: List[Document]) -> Neo4jVector:
    """
    Load existing Neo4j vector index or create a new one from docs.
    """
    print('🌐 Creating Neo4j vectorstore...')
    try:
...
def main() -> None:
    ...
    # neo4j_store = init_neo4j_vector(embeddings, docs)
    ...
    ensemble = EnsembleRetriever(
        ...
        weights=[1, 1]
        # retrievers=[bm25_retriever, chroma_retriever, neo4j_retriever],
        # weights=[1, 1, 1]
    )
